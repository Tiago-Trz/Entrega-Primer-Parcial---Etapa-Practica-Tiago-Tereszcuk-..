...
def main():
    ...
    if opcion == "1":
        ...
        if contrasenia == "":
            print("ERROR: Primero ingresa tu contraseña (opcion 1).")
        else:
            nivel = validaciones.validar_seguridad(contrsenia)
            print(f"El nivel de seguirdad de la contraseña es: {nivel}")
    elif opcion == "3":
        if contrasenia == "":
